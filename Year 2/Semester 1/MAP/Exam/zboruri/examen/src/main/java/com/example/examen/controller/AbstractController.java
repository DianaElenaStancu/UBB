...
public abstract class AbstractController implements Controller {
     ...
     */
    public void loadPage(Service service, Client client, HotelDTO hotelDTO, URL location, String title, Integer width, Integer height) throws IOException {
