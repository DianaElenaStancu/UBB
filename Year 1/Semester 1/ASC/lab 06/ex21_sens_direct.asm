;ex_21(sens direct): Dandu-se un sir de cuvinte sa se obtina sirul (de octeti) cifrelor in baza zece ale fiecarui cuvant din acest sir.
;Exemplu:
;daca avem sirul:
;sir DW 12345, 20778, 4596 
;obtinem rezultatul
;1, 2, 3, 4, 5, 2, 0, 7, 7, 8, 4, 5, 9, 6.
;Solutie: parcurgem fiecare cuvant in sens direct, salvam o copie a numarului si aflam cate cifre are
...
segment code use32 class=code
    start:
        ...
        mov edi, sir_cifre
        dec edi
        cld; parcurgem sirul in sens direct (DF = 0)
        ...
        repetaSir:
            ...
            std; vom insera cifrele numarului de la dreapta la stanga, DF = 1 
