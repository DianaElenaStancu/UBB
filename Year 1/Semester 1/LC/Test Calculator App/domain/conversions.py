from Calculator_App.domain.conversions import convert_din_baza_2, convert_in_baza_2, convert_rapid, convert_directa, convert_din_baza_10, convert_in_baza_10, convert_intermediar
